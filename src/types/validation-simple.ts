/**
 * Simplified Zod Validation Schemas for Alarm & White Noise App
 * 
 * Provides basic runtime type validation for database operations.
 * Simplified to resolve TypeScript compilation issues while maintaining
 * essential validation functionality.
 */
...
export const AlarmSchema = z.object({
  ...
  repeat_days: z.array(z.number().min(0).max(6)).nullable(),
